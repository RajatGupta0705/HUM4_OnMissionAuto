...
public class LoginLogout
{
    ...
    public boolean loginIntoSite(String criteria, String browser) throws Exception
    {
        ...
        {
            String valid_user1 =  PropertiesUtility.getPropertyValue("C:\\Git Test\\HUM4_OnMissionAuto\\src\\test\\java\\resourceFiles\\users.properties" , "valid_user");
            String password1 =  PropertiesUtility.getPropertyValue("C:\\Git Test\\HUM4_OnMissionAuto\\src\\test\\java\\resourceFiles\\users.properties" , "password");
        ...
        {
            String valid_user2 =  PropertiesUtility.getPropertyValue("C:\\Git Test\\HUM4_OnMissionAuto\\src\\test\\java\\resourceFiles\\users.properties" , "locked_user");
            String password2 =  PropertiesUtility.getPropertyValue("C:\\Git Test\\HUM4_OnMissionAuto\\src\\test\\java\\resourceFiles\\users.properties" , "password");
