...
public class RunnerClassUtility
{
    public static void main(String [] args) throws  Exception {
        ...
        String[] criterias = {"valid", "locked user", "invalid"};
            ...
            for (int i = 0; i < browsers.length; i++) {
                ...
                if (lobj.loginIntoSite(cr, browsers[i])) {
                    ...
                    if (lobj.logoutSite()) {
                        ...
                        System.out.println("user logged in but unable to log out. Login test case failed for valid user in " + browsers[i] + " browser");
                }
                Thread.sleep(2000);
